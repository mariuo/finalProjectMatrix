...
*/
                        ...
                        if (!$send) {
                            // echo '<script type="text/javascript">alert("i_code error. Please try again.");
                            echo '<script type="text/javascript">alert("Your i_code is: ' . $i_code . '");
                </script>';
                            echo ("<script>location.href='transf_anyone_bank.php'</script>");
                        } else {
                ...
                <div class="login-content">
                    <div class="login-logo">
                        ...
                        <h2 style="position: relative; left: -10%;">
                            <font color="grey"> <b> Anyone Bank Transfer </b> </font>
                        </h2>
                    </div>
                    ...
                    <div class="login-form" style="width: 550px; position: relative; left: -10%;">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <input type="text" class="form-control col-sm-8" name="IBAN" placeholder="e.g.: EA#########################" pattern="[A-Z]{2}[0-9]{13,32}" title="The first two uppercase letters and then up to 32 digits" required>
        ...
        <?php
        require_once('transf_anyone_bank_check_recipient.php');
        require_once('transf_anyone_bank_balance.php');
        require_once('transf_anyone_bank_limit.php');
        require_once('transf_anyone_bank_i_code.php');
        require_once('transf_anyone_bank_send.php');
        require_once('transf_anyone_bank_transac.php');
        ?>
