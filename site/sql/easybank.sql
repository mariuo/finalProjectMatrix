...
CREATE TABLE
    IF NOT EXISTS `customers` (
        ...
        `IBAN` varchar(32) NOT NULL,
        `publishable_key_stripe` varchar(64) NULL,
        `secret_key_stripe` varchar(64) NULL,
        ...
        `instant_register` varchar(32) NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS `easybank_all_reserves` (
...
CREATE TABLE
    IF NOT EXISTS `easybank_reserve_currency` (
...
CREATE TABLE
    IF NOT EXISTS `transactions_all` (
        `id` int(10) NOT NULL AUTO_INCREMENT,
        `date_transfer` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
        `_from_customer_lastname` varchar(64) NOT NULL,
        `_from_customer_firstname` varchar(32) NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS `transactions_anyone_bank` (
        `id` int(10) NOT NULL AUTO_INCREMENT,
        `date_transfer` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
        `_from_customer_lastname` varchar(64) NOT NULL,
        `_from_customer_firstname` varchar(32) NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS `transactions_easy_bank` (
        `id` int(10) NOT NULL AUTO_INCREMENT,
        `date_transfer` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
        `_from_customer_lastname` varchar(64) NOT NULL,
        `_from_customer_firstname` varchar(32) NOT NULL,
